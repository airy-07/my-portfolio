...
- **Finance Airy** (98% - Web & Android) - Pencatat keuangan dibantu AI.
- **Kost Airy** (40% - Next.js) - Portal manajemen kost.
- **POS Kasir** (10% - Next.js) - Sistem kasir digital sederhana.

Dibuat santai menggunakan HTML, CSS, dan JavaScript.
